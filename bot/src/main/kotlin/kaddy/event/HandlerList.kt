...
import kaddy.plugin.RegisteredListener
...
class HandlerList {
     ...
     */
    @Volatile private var handlers: Array<RegisteredListener>? = null
    ...
    private operator fun EnumMap<EventPriority, ArrayList<RegisteredListener>>.invoke(priority: EventPriority):
    ...
    init {
        ...
        for (o in EventPriority.values()) {
            handlerslots.put(o, ArrayList<RegisteredListener>())
        }
    ...
    fun bake() {
        ...
        val entries = ArrayList<RegisteredListener>()
    ...
    val registeredListeners: Array<RegisteredListener>
        get() {
            var handlers: Array<RegisteredListener>? = this.handlers
            while (handlers == null) {
                bake()
